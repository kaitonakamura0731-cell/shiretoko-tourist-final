...
export const rows: CompareRow[] = [
  {
    ...
    own: 'ほぼ同額（同一商品で並列）',
    advantage: 'tie',
    note: 'ポイント目安・送料・配送条件は、注文前に確認できます。',
  },
  {
    axis: 'ポイント目安',
    yahoo: '1〜5%程度（キャンペーン依存・条件付き）',
    own: '会員向けに1%目安を表示（条件は注文前に確認）',
    advantage: 'own',
    note: '公式ECはポイント目安を表示します。Yahoo は付与条件と上限をご確認ください。',
  },
  {
    axis: '送料',
  ...
  {
    axis: '支払い相談',
    yahoo: 'モール標準の支払い方法に対応',
    own: 'LINEで注文内容と支払い方法を相談',
    advantage: 'tie',
    note: '公式EC側の支払い処理連携はオプションです。',
  },
  {
    axis: '相談・履歴サポート',
    yahoo: 'モール内の案内が中心',
